...
function validarFnac(dato){
    ...
    let expresion = /^((((((0[1-9])|([12]\d)|(3[01]))[\-\/]((0[13578])|(1[02])))|(((0[1-9])|([12]\d)|(30))[\-\/]((0[469])|(11))))[\-\/]\d{4}))|((((0[1-9])|[12]\d))[\-\/]02[\-\/](([02468][048]00)|([13579][26]00)|(\d\d[2468][048])|(\d\d[13579][26])|(\d\d0[48]))|(((0[1-9])|(1\d)|(2[8]))[\-\/]02[\-\/](([02468][1235679]00)|([13579][01345789]00)|(\d\d[02468][1235679])|(\d\d[13579][01345789]))))$/
    if (!expresion.test(dato)) {
        correcto = false;
    }
    return correcto;
/*
    ...
    (((0[1-9])|([12]\d)|(30))[\-\/]((0[469])|(11))))[\-\/]\d{4}))|
    ((((0[1-9])|[12]\d))[\-\/]02[\-\/](([02468][048]00)|([13579][26]00)|(\d\d[2468][048])|(\d\d[13579][26])|(\d\d0[48]))|
    (((0[1-9])|(1\d)|(2[8]))[\-\/]02[\-\/](([02468][1235679]00)|([13579][01345789]00)|(\d\d[02468][1235679])|(\d\d[13579][01345789]))))$/;
*/
